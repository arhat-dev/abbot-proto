...
func (m *NetworkInterface) GetDeleteOnExit() bool {
	if m != nil {
		return m.DeleteOnExit
	}
	return false
}
...
var fileDescriptor_3b5ea8fe65782bcc = []byte{
	...
	,
}
...
func (this *NetworkInterface) Equal(that interface{}) bool {
	...
	if this.DeleteOnExit != that1.DeleteOnExit {
		return false
	}
	return true
}
func (this *NetworkInterface) GoString() string {
	...
	s = append(s, "DeleteOnExit: "+fmt.Sprintf("%#v", this.DeleteOnExit)+",\n")
	s = append(s, "}")
...
func (this *NetworkInterface) String() string {
	...
	s := strings.Join([]string{`&NetworkInterface{`,
		...
		`DeleteOnExit:` + fmt.Sprintf("%v", this.DeleteOnExit) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *NetworkInterface) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteOnExit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
